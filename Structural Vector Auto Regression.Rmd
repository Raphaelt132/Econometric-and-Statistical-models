...
output: pdf_document
---
#This script is still a work in progress. The groundwork for the matrix algebra of the model is mostly done, but more rigorous statistical testing could be added to filter out potential issues.
